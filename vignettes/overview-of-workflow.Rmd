...
#>  1 acc_tcga                Adre… "TCGA … TRUE    "PUBL…      0 2022-0…      92 TRUE    acc     hg19    <NA>  <NA>   
#>  2 bcc_unige_2016          Basa… "Whole… TRUE    "PUBL…      0 2022-0…     293 TRUE    bcc     hg19    2695… Bonill…
#>  3 ampca_bcm_2016          Ampu… "Exome… TRUE    "PUBL…      0 2022-0…     160 TRUE    ampca   hg19    2680… Gingra…
#>  4 blca_dfarber_mskcc_2014 Blad… "Whole… TRUE    "PUBL…      0 2022-0…      50 TRUE    blca    hg19    2509… Van Al…
#>  5 blca_mskcc_solit_2012   Blad… "Compr… TRUE    "PUBL…      0 2022-0…      97 TRUE    blca    hg19    2389… Iyer e…
#>  6 blca_bgi                Blad… "Whole… TRUE    "PUBL…      0 2022-0…      99 TRUE    blca    hg19    2412… Guo et…
#>  7 blca_mskcc_solit_2014   Blad… "Genom… TRUE    "PUBL…      0 2022-0…     109 TRUE    blca    hg19    2509… Kim et…
#>  8 all_stjude_2013         Hypo… "Whole… TRUE    ""          0 2022-0…      44 TRUE    myeloid hg19    2333… Holmfe…
#>  9 acyc_fmi_2014           Aden… "Targe… TRUE    "ACYC…      0 2022-0…      28 TRUE    acyc    hg19    2441… Ross e…
#> 10 acyc_sanger_2013        Aden… "Whole… TRUE    "ACYC…      0 2022-0…      24 TRUE    acyc    hg19    2377… Stephe…
...
#>   studyId         name           descr…¹ publi…² groups status impor…³ allSa…⁴ readP…⁵ cance…⁶ refer…⁷ pmid  citat…⁸
#>   <chr>           <chr>          <chr>   <lgl>   <chr>   <int> <chr>     <int> <lgl>   <chr>   <chr>   <chr> <chr>  
#> 1 blca_nmibc_2017 Nonmuscle Inv… IMPACT… TRUE    PUBLIC      0 2022-0…     105 TRUE    blca    hg19    2858… Pietza…
#> 2 prad_msk_2019   Prostate Canc… MSK-IM… TRUE    PUBLIC      0 2022-0…      18 TRUE    prosta… hg19    3156… Granlu…
...
#> 2 MUTATION_EXTENDED       MAF      Mutations                        Mutation data f… TRUE    FALSE   blca_n… blca_n…
#> 3 STRUCTURAL_VARIANT      SV       Structural variants              Structural Vari… TRUE    FALSE   blca_n… blca_n…
...
#>   <chr>                   <chr>    <chr>                                     <chr>   <lgl>   <lgl>   <chr>   <chr>  
#> 1 COPY_NUMBER_ALTERATION  DISCRETE Putative copy-number alterations (IMPACT… Putati… TRUE    FALSE   prad_m… prad_m…
...
#> # … with abbreviated variable names ¹​description, ²​showProfileInAnalysisTab, ³​patientLevel, ⁴​molecularProfileId
```
...
#> Genes: "IMPACT468"
#> # A tibble: 6 × 33
#>   hugoGeneS…¹ entre…² uniqu…³ uniqu…⁴ molec…⁵ sampl…⁶ patie…⁷ studyId center mutat…⁸ valid…⁹ tumor…˟ tumor…˟ norma…˟
#>   <chr>         <int> <chr>   <chr>   <chr>   <chr>   <chr>   <chr>   <chr>  <chr>   <chr>     <int>   <int>   <int>
#> 1 TERT           7015 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown     130      87       0
#> 2 SMAD4          4089 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown      43     757       0
#> 3 ERBB4          2066 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown     182     500       0
#> 4 CUL3           8452 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown     160     598       0
#> 5 PBRM1         55193 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown      69     778       0
#> 6 APC             324 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown     249     373       0
#> # … with 19 more variables: normalRefCount <int>, startPosition <int>, endPosition <int>, referenceAllele <chr>,
...
#> #   refseqMrnaId <chr>, proteinPosStart <int>, proteinPosEnd <int>, keyword <chr>, and abbreviated variable names
#> #   ¹​hugoGeneSymbol, ²​entrezGeneId, ³​uniqueSampleKey, ⁴​uniquePatientKey, ⁵​molecularProfileId, ⁶​sampleId,
#> #   ⁷​patientId, ⁸​mutationStatus, ⁹​validationStatus, ˟​tumorAltCount, ˟​tumorRefCount, ˟​normalAltCount
```
...
#>  7 Sample Class                  The sample classification (i.e., tumor, ce… STRING  FALSE   1       SAMPLE… prad_m…
#>  8 Number of Samples Per Patient Number of Samples Per Patient               STRING  TRUE    1       SAMPLE… prad_m…
#>  9 Sample Type                   The type of sample (i.e., normal, primary,… STRING  FALSE   1       SAMPLE… prad_m…
#> 10 Sex                           Sex                                         STRING  TRUE    1       SEX     prad_m…
#> 11 Somatic Status                Somatic Status                              STRING  FALSE   1       SOMATI… prad_m…
#> 12 Specimen Preservation Type    The method used for preparing the tissue f… STRING  FALSE   1       SPECIM… prad_m…
