...
#>  1 acc_tcga Adre… "TCGA Adre… TRUE        "PUBL…      0 2022-10-2…             92 TRUE           acc          hg19           
#>  2 all_stj… Acut… "Comprehen… TRUE        "PUBL…      0 2022-10-2…             93 TRUE           bll          hg19           
#>  3 all_stj… Hypo… "Whole gen… TRUE        ""          0 2022-10-2…             44 TRUE           myeloid      hg19           
#>  4 acbc_ms… Aden… "Whole exo… TRUE        "ACYC…      0 2022-10-2…             12 TRUE           acbc         hg19           
#>  5 acyc_fm… Aden… "Targeted … TRUE        "ACYC…      0 2022-10-2…             28 TRUE           acyc         hg19           
#>  6 acyc_jh… Aden… "Whole-gen… TRUE        "ACYC…      0 2022-10-2…             25 TRUE           acyc         hg19           
#>  7 acyc_md… Aden… "WGS of 21… TRUE        "ACYC…      0 2022-10-2…            102 TRUE           acyc         hg19           
#>  8 acyc_sa… Aden… "Whole exo… TRUE        "ACYC…      0 2022-10-2…             24 TRUE           acyc         hg19           
#>  9 all_stj… Acut… "Whole-gen… TRUE        "PUBL…      0 2022-10-2…             73 TRUE           bll          hg19           
#> 10 all_pha… Pedi… "Whole gen… TRUE        "NCI-…      0 2022-10-2…           1978 TRUE           bll          hg19           
#> # ℹ 367 more rows
...
#>   studyId   name  description publicStudy groups status importDate allSampleCount readPermission cancerTypeId referenceGenome
#>   <chr>     <chr> <chr>       <lgl>       <chr>   <int> <chr>               <int> <lgl>          <chr>        <chr>          
#> 1 blca_nmi… Nonm… IMPACT seq… TRUE        PUBLIC      0 2022-10-2…            105 TRUE           blca         hg19           
#> 2 prad_msk… Pros… MSK-IMPACT… TRUE        PUBLIC      0 2022-10-2…             18 TRUE           prostate     hg19           
#> # ℹ 2 more variables: pmid <chr>, citation <chr>
```
...
#> 1 COPY_NUMBER_ALTERATION  DISCRETE Putative copy-… Copy Numbe… TRUE                   FALSE        blca_nmibc_2017_c… blca_n…
#> 2 MUTATION_EXTENDED       MAF      Mutations       Mutation d… TRUE                   FALSE        blca_nmibc_2017_m… blca_n…
#> 3 STRUCTURAL_VARIANT      SV       Structural var… Structural… TRUE                   FALSE        blca_nmibc_2017_s… blca_n…
...
#>   molecularAlterationType datatype name            description showProfileInAnalysi…¹ patientLevel molecularProfileId studyId
#>   <chr>                   <chr>    <chr>           <chr>       <lgl>                  <lgl>        <chr>              <chr>  
#> 1 COPY_NUMBER_ALTERATION  DISCRETE Putative copy-… Putative c… TRUE                   FALSE        prad_msk_2019_cna  prad_m…
#> 2 MUTATION_EXTENDED       MAF      Mutations       IMPACT468 … TRUE                   FALSE        prad_msk_2019_mut… prad_m…
#> 3 STRUCTURAL_VARIANT      SV       Structural var… Structural… TRUE                   FALSE        prad_msk_2019_str… prad_m…
#> # ℹ abbreviated name: ¹​showProfileInAnalysisTab
```
...
#> 1 TERT                   7015 UC0wMDAxNDUzLVQwMS1JTTM6… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> 2 SMAD4                  4089 UC0wMDAxNDUzLVQwMS1JTTM6… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> 3 ERBB4                  2066 UC0wMDAxNDUzLVQwMS1JTTM6… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> 4 CUL3                   8452 UC0wMDAxNDUzLVQwMS1JTTM6… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> 5 PBRM1                 55193 UC0wMDAxNDUzLVQwMS1JTTM6… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> 6 APC                     324 UC0wMDAxNDUzLVQwMS1JTTM6… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
...
#> #   proteinChange <chr>, mutationType <chr>, ncbiBuild <chr>, variantType <chr>, chr <chr>, variantAllele <chr>,
...
#>  7 Sample Class                  The sample classification (i… STRING   FALSE            1        SAMPLE_CLASS        prad_m…
#>  8 Number of Samples Per Patient Number of Samples Per Patient STRING   TRUE             1        SAMPLE_COUNT        prad_m…
#>  9 Sample Type                   The type of sample (i.e., no… STRING   FALSE            1        SAMPLE_TYPE         prad_m…
#> 10 Sex                           Sex                           STRING   TRUE             1        SEX                 prad_m…
#> 11 Somatic Status                Somatic Status                STRING   FALSE            1        SOMATIC_STATUS      prad_m…
#> 12 Specimen Preservation Type    The method used for preparin… STRING   FALSE            1        SPECIMEN_PRESERVAT… prad_m…
