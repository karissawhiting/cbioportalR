...
#>  1 acc_tcga      Adrenocortica… "TCGA Adre… TRUE        PUBLIC      0 2023-06-1…             92 TRUE           acc         
#>  2 laml_tcga     Acute Myeloid… "TCGA Acut… TRUE        PUBLIC      0 2023-06-1…            200 TRUE           aml         
#>  3 blca_tcga     Bladder Uroth… "TCGA Blad… TRUE        PUBLIC      0 2023-06-1…            413 TRUE           blca        
#>  4 kirc_tcga     Kidney Renal … "TCGA Kidn… TRUE        PUBLIC      0 2023-06-1…            538 TRUE           ccrcc       
#>  5 cesc_tcga     Cervical Squa… "TCGA Cerv… TRUE        PUBLIC      0 2023-06-1…            310 TRUE           cesc        
#>  6 chol_tcga     Cholangiocarc… "TCGA Chol… TRUE        PUBLIC      0 2023-06-1…             51 TRUE           chol        
#>  7 kich_tcga     Kidney Chromo… "TCGA Kidn… TRUE        PUBLIC      0 2023-06-1…            113 TRUE           chrcc       
#>  8 coadread_tcga Colorectal Ad… "TCGA Colo… TRUE        PUBLIC      0 2023-06-1…            640 TRUE           coadread    
#>  9 dlbc_tcga     Lymphoid Neop… "TCGA Lymp… TRUE        PUBLIC      0 2023-06-1…             48 TRUE           dlbclnos    
#> 10 esca_tcga     Esophageal Ca… "TCGA Esop… TRUE        PUBLIC      0 2023-06-1…            186 TRUE           esca        
#> # ℹ 385 more rows
...
#> # A tibble: 2 × 13
#>   studyId name  description publicStudy groups status importDate allSampleCount readPermission cancerTypeId referenceGenome
#>   <chr>   <chr> <chr>       <lgl>       <chr>   <int> <chr>               <int> <lgl>          <chr>        <chr>          
#> 1 prad_m… Pros… MSK-IMPACT… TRUE        PUBLIC      0 2023-06-2…             18 TRUE           prostate     hg19           
#> 2 blca_n… Nonm… IMPACT seq… TRUE        PUBLIC      0 2023-07-1…            105 TRUE           blca         hg19           
#> # ℹ 2 more variables: pmid <chr>, citation <chr>
```
...
#> # A tibble: 3 × 8
#>   molecularAlterationType datatype name          description showProfileInAnalysi…¹ patientLevel molecularProfileId studyId
#>   <chr>                   <chr>    <chr>         <chr>       <lgl>                  <lgl>        <chr>              <chr>  
#> 1 COPY_NUMBER_ALTERATION  DISCRETE Putative cop… Copy Numbe… TRUE                   FALSE        blca_nmibc_2017_c… blca_n…
#> 2 MUTATION_EXTENDED       MAF      Mutations     Mutation d… TRUE                   FALSE        blca_nmibc_2017_m… blca_n…
#> 3 STRUCTURAL_VARIANT      SV       Structural v… Structural… TRUE                   FALSE        blca_nmibc_2017_s… blca_n…
...
#>   molecularAlterationType datatype name          description showProfileInAnalysi…¹ patientLevel molecularProfileId studyId
#>   <chr>                   <chr>    <chr>         <chr>       <lgl>                  <lgl>        <chr>              <chr>  
#> 1 COPY_NUMBER_ALTERATION  DISCRETE Putative cop… Putative c… TRUE                   FALSE        prad_msk_2019_cna  prad_m…
#> 2 MUTATION_EXTENDED       MAF      Mutations     IMPACT468 … TRUE                   FALSE        prad_msk_2019_mut… prad_m…
#> 3 STRUCTURAL_VARIANT      SV       Structural v… Structural… TRUE                   FALSE        prad_msk_2019_str… prad_m…
#> # ℹ abbreviated name: ¹​showProfileInAnalysisTab
```
...
#> Genes: "IMPACT468"
#> # A tibble: 6 × 28
#>   hugoGeneSymbol entrezGeneId uniqueSampleKey         uniquePatientKey molecularProfileId sampleId patientId studyId center
#>   <chr>                 <int> <chr>                   <chr>            <chr>              <chr>    <chr>     <chr>   <chr> 
#> 1 SMAD4                  4089 UC0wMDAxNDUzLVQwMS1JTT… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> 2 TERT                   7015 UC0wMDAxNDUzLVQwMS1JTT… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> 3 ERBB4                  2066 UC0wMDAxNDUzLVQwMS1JTT… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> 4 CUL3                   8452 UC0wMDAxNDUzLVQwMS1JTT… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> 5 PBRM1                 55193 UC0wMDAxNDUzLVQwMS1JTT… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> 6 APC                     324 UC0wMDAxNDUzLVQwMS1JTT… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> # ℹ 19 more variables: mutationStatus <chr>, validationStatus <chr>, tumorAltCount <int>, tumorRefCount <int>,
#> #   normalAltCount <int>, normalRefCount <int>, startPosition <int>, endPosition <int>, referenceAllele <chr>,
#> #   proteinChange <chr>, mutationType <chr>, ncbiBuild <chr>, variantType <chr>, keyword <chr>, chr <chr>,
#> #   variantAllele <chr>, refseqMrnaId <chr>, proteinPosStart <int>, proteinPosEnd <int>
```
...
#>  2 Cancer Type Detailed          Cancer Type Detailed        STRING   FALSE            1        CANCER_TYPE_DETAIL… prad_m…
#>  3 Fraction Genome Altered       Fraction Genome Altered     NUMBER   FALSE            20       FRACTION_GENOME_AL… prad_m…
...
#>  7 Sample Class                  The sample classification … STRING   FALSE            1        SAMPLE_CLASS        prad_m…
#>  8 Number of Samples Per Patient Number of Samples Per Pati… STRING   TRUE             1        SAMPLE_COUNT        prad_m…
#>  9 Sample Type                   The type of sample (i.e., … STRING   FALSE            1        SAMPLE_TYPE         prad_m…
#> 10 Sex                           Sex                         STRING   TRUE             1        SEX                 prad_m…
#> 11 Somatic Status                Somatic Status              STRING   FALSE            1        SOMATIC_STATUS      prad_m…
#> 12 Specimen Preservation Type    The method used for prepar… STRING   FALSE            1        SPECIMEN_PRESERVAT… prad_m…
#> 13 TMB (nonsynonymous)           TMB (nonsynonymous)         NUMBER   FALSE            1        TMB_NONSYNONYMOUS   prad_m…
```
