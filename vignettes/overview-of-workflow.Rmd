...
#>  1 acc_tcga                Adrenocorti… "TCGA … TRUE    "PUBL…      0 2022-0…      92 TRUE    acc     hg19    <NA>  <NA>   
#>  2 bcc_unige_2016          Basal Cell … "Whole… TRUE    "PUBL…      0 2022-0…     293 TRUE    bcc     hg19    2695… Bonill…
#>  3 ampca_bcm_2016          Ampullary C… "Exome… TRUE    "PUBL…      0 2022-0…     160 TRUE    ampca   hg19    2680… Gingra…
#>  4 blca_dfarber_mskcc_2014 Bladder Uro… "Whole… TRUE    "PUBL…      0 2022-0…      50 TRUE    blca    hg19    2509… Van Al…
#>  5 blca_mskcc_solit_2012   Bladder Can… "Compr… TRUE    "PUBL…      0 2022-0…      97 TRUE    blca    hg19    2389… Iyer e…
#>  6 blca_bgi                Bladder Uro… "Whole… TRUE    "PUBL…      0 2022-0…      99 TRUE    blca    hg19    2412… Guo et…
#>  7 blca_mskcc_solit_2014   Bladder Can… "Genom… TRUE    "PUBL…      0 2022-0…     109 TRUE    blca    hg19    2509… Kim et…
#>  8 all_stjude_2013         Hypodiploid… "Whole… TRUE    ""          0 2022-0…      44 TRUE    myeloid hg19    2333… Holmfe…
#>  9 acyc_fmi_2014           Adenoid Cys… "Targe… TRUE    "ACYC…      0 2022-0…      28 TRUE    acyc    hg19    2441… Ross e…
#> 10 acyc_sanger_2013        Adenoid Cys… "Whole… TRUE    "ACYC…      0 2022-0…      24 TRUE    acyc    hg19    2377… Stephe…
#> # … with 341 more rows, and abbreviated variable names ¹​description, ²​publicStudy, ³​importDate, ⁴​allSampleCount,
#> #   ⁵​readPermission, ⁶​cancerTypeId, ⁷​referenceGenome, ⁸​citation
```
...
#>   studyId         name                  descr…¹ publi…² groups status impor…³ allSa…⁴ readP…⁵ cance…⁶ refer…⁷ pmid  citat…⁸
#>   <chr>           <chr>                 <chr>   <lgl>   <chr>   <int> <chr>     <int> <lgl>   <chr>   <chr>   <chr> <chr>  
#> 1 blca_nmibc_2017 Nonmuscle Invasive B… IMPACT… TRUE    PUBLIC      0 2022-0…     105 TRUE    blca    hg19    2858… Pietza…
#> 2 prad_msk_2019   Prostate Cancer (MSK… MSK-IM… TRUE    PUBLIC      0 2022-0…      18 TRUE    prosta… hg19    3156… Granlu…
#> # … with abbreviated variable names ¹​description, ²​publicStudy, ³​importDate, ⁴​allSampleCount, ⁵​readPermission,
#> #   ⁶​cancerTypeId, ⁷​referenceGenome, ⁸​citation
```
...
#> 2 MUTATION_EXTENDED       MAF      Mutations                        Mutation data from nex… TRUE    FALSE   blca_n… blca_n…
#> 3 STRUCTURAL_VARIANT      SV       Structural variants              Structural Variant Dat… TRUE    FALSE   blca_n… blca_n…
...
#>   molecularAlterationType datatype name                                         description showP…¹ patie…² molec…³ studyId
#>   <chr>                   <chr>    <chr>                                        <chr>       <lgl>   <lgl>   <chr>   <chr>  
#> 1 COPY_NUMBER_ALTERATION  DISCRETE Putative copy-number alterations (IMPACT468) Putative c… TRUE    FALSE   prad_m… prad_m…
#> 2 MUTATION_EXTENDED       MAF      Mutations                                    IMPACT468 … TRUE    FALSE   prad_m… prad_m…
#> 3 STRUCTURAL_VARIANT      SV       Structural variants                          Structural… TRUE    FALSE   prad_m… prad_m…
#> # … with abbreviated variable names ¹​showProfileInAnalysisTab, ²​patientLevel, ³​molecularProfileId
```
...
#> Genes: "IMPACT468"
#> # A tibble: 6 × 33
#>   hugoGene…¹ entre…² uniqu…³ uniqu…⁴ molec…⁵ sampl…⁶ patie…⁷ studyId center mutat…⁸ valid…⁹ tumor…˟ tumor…˟
#>   <chr>        <int> <chr>   <chr>   <chr>   <chr>   <chr>   <chr>   <chr>  <chr>   <chr>     <int>   <int>
#> 1 TERT          7015 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown     130      87
#> 2 SMAD4         4089 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown      43     757
#> 3 ERBB4         2066 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown     182     500
#> 4 CUL3          8452 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown     160     598
#> 5 PBRM1        55193 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown      69     778
#> 6 APC            324 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown     249     373
#> # … with 20 more variables: normalAltCount <int>, normalRefCount <int>, startPosition <int>,
#> #   endPosition <int>, referenceAllele <chr>, proteinChange <chr>, mutationType <chr>,
#> #   functionalImpactScore <chr>, fisValue <dbl>, linkXvar <chr>, linkPdb <chr>, linkMsa <chr>,
#> #   ncbiBuild <chr>, variantType <chr>, chr <chr>, variantAllele <chr>, refseqMrnaId <chr>,
#> #   proteinPosStart <int>, proteinPosEnd <int>, keyword <chr>, and abbreviated variable names
#> #   ¹​hugoGeneSymbol, ²​entrezGeneId, ³​uniqueSampleKey, ⁴​uniquePatientKey, ⁵​molecularProfileId, ⁶​sampleId,
#> #   ⁷​patientId, ⁸​mutationStatus, ⁹​validationStatus, ˟​tumorAltCount, ˟​tumorRefCount
```
...
#>  7 Sample Class                  The sample classification (i.e., … STRING  FALSE   1       SAMPLE… prad_m…
#>  8 Number of Samples Per Patient Number of Samples Per Patient      STRING  TRUE    1       SAMPLE… prad_m…
#>  9 Sample Type                   The type of sample (i.e., normal,… STRING  FALSE   1       SAMPLE… prad_m…
#> 10 Sex                           Sex                                STRING  TRUE    1       SEX     prad_m…
#> 11 Somatic Status                Somatic Status                     STRING  FALSE   1       SOMATI… prad_m…
#> 12 Specimen Preservation Type    The method used for preparing the… STRING  FALSE   1       SPECIM… prad_m…
#> 13 TMB (nonsynonymous)           TMB (nonsynonymous)                NUMBER  FALSE   1       TMB_NO… prad_m…
#> # … with abbreviated variable names ¹​datatype, ²​patientAttribute, ³​priority, ⁴​clinicalAttributeId
```
