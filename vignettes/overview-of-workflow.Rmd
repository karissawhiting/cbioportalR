...
#>  1 acc_tcga                Adrenocortical Carcinoma (TCGA, Firehose Legacy)  "TCGA … TRUE    "PUBL…      0 2022-0…      92 TRUE    acc     hg19    <NA>  <NA>   
#>  2 bcc_unige_2016          Basal Cell Carcinoma (UNIGE, Nat Genet 2016)      "Whole… TRUE    "PUBL…      0 2022-0…     293 TRUE    bcc     hg19    2695… Bonill…
#>  3 ampca_bcm_2016          Ampullary Carcinoma (Baylor College of Medicine,… "Exome… TRUE    "PUBL…      0 2022-0…     160 TRUE    ampca   hg19    2680… Gingra…
#>  4 blca_dfarber_mskcc_2014 Bladder Urothelial Carcinoma (DFCI/MSKCC, Cancer… "Whole… TRUE    "PUBL…      0 2022-0…      50 TRUE    blca    hg19    2509… Van Al…
#>  5 blca_mskcc_solit_2012   Bladder Cancer (MSKCC, J Clin Onco 2013)          "Compr… TRUE    "PUBL…      0 2022-0…      97 TRUE    blca    hg19    2389… Iyer e…
#>  6 blca_bgi                Bladder Urothelial Carcinoma (BGI, Nat Genet 201… "Whole… TRUE    "PUBL…      0 2022-0…      99 TRUE    blca    hg19    2412… Guo et…
#>  7 blca_mskcc_solit_2014   Bladder Cancer (MSKCC, Eur Urol 2014)             "Genom… TRUE    "PUBL…      0 2022-0…     109 TRUE    blca    hg19    2509… Kim et…
#>  8 all_stjude_2013         Hypodiploid Acute Lymphoid Leukemia (St Jude, Na… "Whole… TRUE    ""          0 2022-0…      44 TRUE    myeloid hg19    2333… Holmfe…
#>  9 acyc_fmi_2014           Adenoid Cystic Carcinoma (FMI, Am J Surg Pathl. … "Targe… TRUE    "ACYC…      0 2022-0…      28 TRUE    acyc    hg19    2441… Ross e…
#> 10 acyc_sanger_2013        Adenoid Cystic Carcinoma (Sanger/MDA, JCI 2013)   "Whole… TRUE    "ACYC…      0 2022-0…      24 TRUE    acyc    hg19    2377… Stephe…
#> # … with 350 more rows, and abbreviated variable names ¹​description, ²​publicStudy, ³​importDate, ⁴​allSampleCount, ⁵​readPermission, ⁶​cancerTypeId,
#> #   ⁷​referenceGenome, ⁸​citation
```
...
#> # A tibble: 2 × 13
#>   studyId         name                                                  description  publi…¹ groups status impor…² allSa…³ readP…⁴ cance…⁵ refer…⁶ pmid  citat…⁷
#>   <chr>           <chr>                                                 <chr>        <lgl>   <chr>   <int> <chr>     <int> <lgl>   <chr>   <chr>   <chr> <chr>  
#> 1 blca_nmibc_2017 Nonmuscle Invasive Bladder Cancer (MSK Eur Urol 2017) IMPACT sequ… TRUE    PUBLIC      0 2022-0…     105 TRUE    blca    hg19    2858… Pietza…
#> 2 prad_msk_2019   Prostate Cancer (MSK, Cell Metab 2020)                MSK-IMPACT … TRUE    PUBLIC      0 2022-0…      18 TRUE    prosta… hg19    3156… Granlu…
#> # … with abbreviated variable names ¹​publicStudy, ²​importDate, ³​allSampleCount, ⁴​readPermission, ⁵​cancerTypeId, ⁶​referenceGenome, ⁷​citation
```
...
#> # A tibble: 3 × 8
#>   molecularAlterationType datatype name                             description                             showProfileInAnalysisTab patientLe…¹ molec…² studyId
...
#> 2 MUTATION_EXTENDED       MAF      Mutations                        Mutation data from next-gen sequencing. TRUE                     FALSE       blca_n… blca_n…
#> 3 STRUCTURAL_VARIANT      SV       Structural variants              Structural Variant Data.                TRUE                     FALSE       blca_n… blca_n…
#> # … with abbreviated variable names ¹​patientLevel, ²​molecularProfileId
```
...
#>   <chr>                   <chr>    <chr>                                        <chr>                                            <lgl>   <lgl>   <chr>   <chr>  
#> 1 COPY_NUMBER_ALTERATION  DISCRETE Putative copy-number alterations (IMPACT468) Putative copy-number calls derived from IMPACT4… TRUE    FALSE   prad_m… prad_m…
#> 2 MUTATION_EXTENDED       MAF      Mutations                                    IMPACT468 sequencing of tumor/normal samples     TRUE    FALSE   prad_m… prad_m…
#> 3 STRUCTURAL_VARIANT      SV       Structural variants                          Structural Variant Data.                         TRUE    FALSE   prad_m… prad_m…
...
#> [1] "blca_nmibc_2017_cna"                 "blca_nmibc_2017_mutations"           "blca_nmibc_2017_structural_variants"
```
...
#> Genes: "IMPACT468"
#> # A tibble: 6 × 33
#>   hugoG…¹ entre…² uniqu…³ uniqu…⁴ molec…⁵ sampl…⁶ patie…⁷ studyId center mutat…⁸ valid…⁹ tumor…˟ tumor…˟ norma…˟ norma…˟ start…˟ endPo…˟ refer…˟ prote…˟ mutat…˟
#>   <chr>     <int> <chr>   <chr>   <chr>   <chr>   <chr>   <chr>   <chr>  <chr>   <chr>     <int>   <int>   <int>   <int>   <int>   <int> <chr>   <chr>   <chr>  
#> 1 TERT       7015 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown     130      87       0      72  1.30e6  1.30e6 G       Promot… 5'Flank
#> 2 SMAD4      4089 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown      43     757       0     314  4.86e7  4.86e7 G       D424N   Missen…
#> 3 ERBB4      2066 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown     182     500       0     402  2.12e8  2.12e8 C       D1131N  Missen…
#> 4 CUL3       8452 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown     160     598       0     450  2.25e8  2.25e8 C       Q222H   Missen…
#> 5 PBRM1     55193 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown      69     778       0     269  5.26e7  5.26e7 C       A1526P  Missen…
#> 6 APC         324 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC  SOMATIC Unknown     249     373       0     415  1.12e8  1.12e8 T       I169T   Missen…
#> # … with 13 more variables: functionalImpactScore <chr>, fisValue <dbl>, linkXvar <chr>, linkPdb <chr>, linkMsa <chr>, ncbiBuild <chr>, variantType <chr>,
#> #   chr <chr>, variantAllele <chr>, refseqMrnaId <chr>, proteinPosStart <int>, proteinPosEnd <int>, keyword <chr>, and abbreviated variable names
#> #   ¹​hugoGeneSymbol, ²​entrezGeneId, ³​uniqueSampleKey, ⁴​uniquePatientKey, ⁵​molecularProfileId, ⁶​sampleId, ⁷​patientId, ⁸​mutationStatus, ⁹​validationStatus,
#> #   ˟​tumorAltCount, ˟​tumorRefCount, ˟​normalAltCount, ˟​normalRefCount, ˟​startPosition, ˟​endPosition, ˟​referenceAllele, ˟​proteinChange, ˟​mutationType
```
...
attr_prad
#> # A tibble: 13 × 7
#>    displayName                   description                                                         datatype patientAttribute priority clinicalAttrib…¹ studyId
...
#>  7 Sample Class                  The sample classification (i.e., tumor, cellline, xenograph).       STRING   FALSE            1        SAMPLE_CLASS     prad_m…
#>  8 Number of Samples Per Patient Number of Samples Per Patient                                       STRING   TRUE             1        SAMPLE_COUNT     prad_m…
#>  9 Sample Type                   The type of sample (i.e., normal, primary, met, recurrence).        STRING   FALSE            1        SAMPLE_TYPE      prad_m…
#> 10 Sex                           Sex                                                                 STRING   TRUE             1        SEX              prad_m…
#> 11 Somatic Status                Somatic Status                                                      STRING   FALSE            1        SOMATIC_STATUS   prad_m…
#> 12 Specimen Preservation Type    The method used for preparing the tissue for examination and study. STRING   FALSE            1        SPECIMEN_PRESER… prad_m…
#> 13 TMB (nonsynonymous)           TMB (nonsynonymous)                                                 NUMBER   FALSE            1        TMB_NONSYNONYMO… prad_m…
#> # … with abbreviated variable name ¹​clinicalAttributeId
```
