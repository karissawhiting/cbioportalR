...
#>  1 acc_tcga            Adre… "TCGA Adre… TRUE        "PUBL…      0 2022-03-0…             92
#>  2 blca_plasmacytoid_… Blad… "Whole exo… TRUE        ""          0 2022-03-0…             34
#>  3 bcc_unige_2016      Basa… "Whole-exo… TRUE        "PUBL…      0 2022-03-0…            293
#>  4 all_stjude_2015     Acut… "Comprehen… TRUE        "PUBL…      0 2022-03-0…             93
#>  5 ampca_bcm_2016      Ampu… "Exome seq… TRUE        "PUBL…      0 2022-03-0…            160
#>  6 blca_dfarber_mskcc… Blad… "Whole exo… TRUE        "PUBL…      0 2022-03-0…             50
#>  7 blca_mskcc_solit_2… Blad… "Comprehen… TRUE        "PUBL…      0 2022-03-0…             97
#>  8 blca_bgi            Blad… "Whole-exo… TRUE        "PUBL…      0 2022-03-0…             99
#>  9 blca_mskcc_solit_2… Blad… "Genomic P… TRUE        "PUBL…      0 2022-03-0…            109
#> 10 all_stjude_2013     Hypo… "Whole gen… TRUE        ""          0 2022-03-0…             44
#> # … with 337 more rows, and 5 more variables: readPermission <lgl>, cancerTypeId <chr>,
...
#>   studyId         name       description publicStudy groups status importDate allSampleCount
#>   <chr>           <chr>      <chr>       <lgl>       <chr>   <int> <chr>               <int>
#> 1 blca_nmibc_2017 Nonmuscle… IMPACT seq… TRUE        PUBLIC      0 2022-03-0…            105
#> 2 prad_msk_2019   Prostate … MSK-IMPACT… TRUE        PUBLIC      0 2022-03-0…             18
#> # … with 5 more variables: readPermission <lgl>, cancerTypeId <chr>, referenceGenome <chr>,
#> #   pmid <chr>, citation <chr>
```
...
#> # A tibble: 3 × 8
#>   molecularAltera… datatype name  description showProfileInAn… patientLevel molecularProfil…
#>   <chr>            <chr>    <chr> <chr>       <lgl>            <lgl>        <chr>           
#> 1 COPY_NUMBER_ALT… DISCRETE Puta… Copy Numbe… TRUE             FALSE        blca_nmibc_2017…
#> 2 MUTATION_EXTEND… MAF      Muta… Mutation d… TRUE             FALSE        blca_nmibc_2017…
#> 3 STRUCTURAL_VARI… FUSION   Fusi… Fusions.    TRUE             FALSE        blca_nmibc_2017…
...
#>   molecularAltera… datatype name  description showProfileInAn… patientLevel molecularProfil…
#>   <chr>            <chr>    <chr> <chr>       <lgl>            <lgl>        <chr>           
#> 1 COPY_NUMBER_ALT… DISCRETE Puta… Putative c… TRUE             FALSE        prad_msk_2019_c…
#> 2 MUTATION_EXTEND… MAF      Muta… IMPACT468 … TRUE             FALSE        prad_msk_2019_m…
#> 3 STRUCTURAL_VARI… FUSION   Fusi… Fusion dat… TRUE             FALSE        prad_msk_2019_f…
#> # … with 1 more variable: studyId <chr>
```
...
#> Genes: "IMPACT468"
#> # A tibble: 6 × 33
#>   hugoGeneSymbol entrezGeneId uniqueSampleKey     uniquePatientKey molecularProfil… sampleId
#>   <chr>                 <int> <chr>               <chr>            <chr>            <chr>   
#> 1 TERT                   7015 UC0wMDAxNDUzLVQwMS… UC0wMDAxNDUzOmJ… blca_nmibc_2017… P-00014…
#> 2 SMAD4                  4089 UC0wMDAxNDUzLVQwMS… UC0wMDAxNDUzOmJ… blca_nmibc_2017… P-00014…
#> 3 ERBB4                  2066 UC0wMDAxNDUzLVQwMS… UC0wMDAxNDUzOmJ… blca_nmibc_2017… P-00014…
#> 4 CUL3                   8452 UC0wMDAxNDUzLVQwMS… UC0wMDAxNDUzOmJ… blca_nmibc_2017… P-00014…
#> 5 PBRM1                 55193 UC0wMDAxNDUzLVQwMS… UC0wMDAxNDUzOmJ… blca_nmibc_2017… P-00014…
#> 6 APC                     324 UC0wMDAxNDUzLVQwMS… UC0wMDAxNDUzOmJ… blca_nmibc_2017… P-00014…
#> # … with 27 more variables: patientId <chr>, studyId <chr>, center <chr>,
#> #   mutationStatus <chr>, validationStatus <chr>, tumorAltCount <int>, tumorRefCount <int>,
#> #   normalAltCount <int>, normalRefCount <int>, startPosition <int>, endPosition <int>,
#> #   referenceAllele <chr>, proteinChange <chr>, mutationType <chr>,
#> #   functionalImpactScore <chr>, fisValue <dbl>, linkXvar <chr>, linkPdb <chr>,
#> #   linkMsa <chr>, ncbiBuild <chr>, variantType <chr>, chr <chr>, variantAllele <chr>,
...
#>  2 Cancer Type Deta… Cancer Typ… STRING   FALSE            1        CANCER_TYPE_DET… prad_m…
#>  3 Fraction Genome … Fraction G… NUMBER   FALSE            20       FRACTION_GENOME… prad_m…
...
#>  8 Number of Sample… Number of … STRING   TRUE             1        SAMPLE_COUNT     prad_m…
...
#> 12 Specimen Preserv… The method… STRING   FALSE            1        SPECIMEN_PRESER… prad_m…
#> 13 TMB (nonsynonymo… TMB (nonsy… NUMBER   FALSE            1        TMB_NONSYNONYMO… prad_m…
```
...
#> 2 P-0001453-T01-IM3 P-0001453 blca_nmibc_2017 CANCER_TYPE_DETAILED    Bladder Urothelial Ca…
