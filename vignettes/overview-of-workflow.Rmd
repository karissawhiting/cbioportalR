...
#>  2 bcc_unige_2… Basa… "Whole… TRUE    "PUBL…      0 2022-0…     293 TRUE    bcc    
#>  3 ampca_bcm_2… Ampu… "Exome… TRUE    "PUBL…      0 2022-0…     160 TRUE    ampca  
#>  4 blca_dfarbe… Blad… "Whole… TRUE    "PUBL…      0 2022-0…      50 TRUE    blca   
#>  5 blca_mskcc_… Blad… "Compr… TRUE    "PUBL…      0 2022-0…      97 TRUE    blca   
#>  6 blca_bgi     Blad… "Whole… TRUE    "PUBL…      0 2022-0…      99 TRUE    blca   
#>  7 blca_mskcc_… Blad… "Genom… TRUE    "PUBL…      0 2022-0…     109 TRUE    blca   
#>  8 all_stjude_… Hypo… "Whole… TRUE    ""          0 2022-0…      44 TRUE    myeloid
#>  9 acyc_fmi_20… Aden… "Targe… TRUE    "ACYC…      0 2022-0…      28 TRUE    acyc   
#> 10 acyc_sanger… Aden… "Whole… TRUE    "ACYC…      0 2022-0…      24 TRUE    acyc   
...
#>   studyId       name  descr…¹ publi…² groups status impor…³ allSa…⁴ readP…⁵ cance…⁶
#>   <chr>         <chr> <chr>   <lgl>   <chr>   <int> <chr>     <int> <lgl>   <chr>  
#> 1 blca_nmibc_2… Nonm… IMPACT… TRUE    PUBLIC      0 2022-0…     105 TRUE    blca   
#> 2 prad_msk_2019 Pros… MSK-IM… TRUE    PUBLIC      0 2022-0…      18 TRUE    prosta…
#> # … with 3 more variables: referenceGenome <chr>, pmid <chr>, citation <chr>, and
#> #   abbreviated variable names ¹​description, ²​publicStudy, ³​importDate,
...
#> 1 COPY_NUMBER_ALTERATION  DISCRETE Putativ… Copy N… TRUE    FALSE   blca_n… blca_n…
#> 2 MUTATION_EXTENDED       MAF      Mutatio… Mutati… TRUE    FALSE   blca_n… blca_n…
#> 3 STRUCTURAL_VARIANT      SV       Structu… Struct… TRUE    FALSE   blca_n… blca_n…
...
#>   molecularAlterationType datatype name     descr…¹ showP…² patie…³ molec…⁴ studyId
#>   <chr>                   <chr>    <chr>    <chr>   <lgl>   <lgl>   <chr>   <chr>  
#> 1 COPY_NUMBER_ALTERATION  DISCRETE Putativ… Putati… TRUE    FALSE   prad_m… prad_m…
#> 2 MUTATION_EXTENDED       MAF      Mutatio… IMPACT… TRUE    FALSE   prad_m… prad_m…
#> 3 STRUCTURAL_VARIANT      SV       Structu… Struct… TRUE    FALSE   prad_m… prad_m…
#> # … with abbreviated variable names ¹​description, ²​showProfileInAnalysisTab,
#> #   ³​patientLevel, ⁴​molecularProfileId
```
...
#> Genes: "IMPACT468"
#> # A tibble: 6 × 33
#>   hugoGene…¹ entre…² uniqu…³ uniqu…⁴ molec…⁵ sampl…⁶ patie…⁷ studyId center mutat…⁸
...
attr_prad
#> # A tibble: 13 × 7
#>    displayName                   descript…¹ datat…² patie…³ prior…⁴ clini…⁵ studyId
#>    <chr>                         <chr>      <chr>   <lgl>   <chr>   <chr>   <chr>  
#>  1 Cancer Type                   Cancer Ty… STRING  FALSE   1       CANCER… prad_m…
#>  2 Cancer Type Detailed          Cancer Ty… STRING  FALSE   1       CANCER… prad_m…
#>  3 Fraction Genome Altered       Fraction … NUMBER  FALSE   20      FRACTI… prad_m…
#>  4 Gene Panel                    Gene Pane… STRING  FALSE   1       GENE_P… prad_m…
#>  5 Mutation Count                Mutation … NUMBER  FALSE   30      MUTATI… prad_m…
#>  6 Oncotree Code                 Oncotree … STRING  FALSE   1       ONCOTR… prad_m…
#>  7 Sample Class                  The sampl… STRING  FALSE   1       SAMPLE… prad_m…
#>  8 Number of Samples Per Patient Number of… STRING  TRUE    1       SAMPLE… prad_m…
#>  9 Sample Type                   The type … STRING  FALSE   1       SAMPLE… prad_m…
#> 10 Sex                           Sex        STRING  TRUE    1       SEX     prad_m…
#> 11 Somatic Status                Somatic S… STRING  FALSE   1       SOMATI… prad_m…
#> 12 Specimen Preservation Type    The metho… STRING  FALSE   1       SPECIM… prad_m…
#> 13 TMB (nonsynonymous)           TMB (nons… NUMBER  FALSE   1       TMB_NO… prad_m…
...
#>   <chr>             <chr>     <chr>           <chr>                   <chr>        
#> 1 P-0001453-T01-IM3 P-0001453 blca_nmibc_2017 CANCER_TYPE             Bladder Canc…
#> 2 P-0001453-T01-IM3 P-0001453 blca_nmibc_2017 CANCER_TYPE_DETAILED    Bladder Urot…
