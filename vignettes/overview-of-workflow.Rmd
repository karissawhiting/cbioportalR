...
#>  2 all_stjude_20… Acut… "Comprehen… TRUE        "PUBL…      0 2022-10-2…             93 TRUE           bll         
#>  3 all_stjude_20… Hypo… "Whole gen… TRUE        ""          0 2022-10-2…             44 TRUE           myeloid     
#>  4 acbc_mskcc_20… Aden… "Whole exo… TRUE        "ACYC…      0 2022-10-2…             12 TRUE           acbc        
#>  5 acyc_fmi_2014  Aden… "Targeted … TRUE        "ACYC…      0 2022-10-2…             28 TRUE           acyc        
#>  6 acyc_jhu_2016  Aden… "Whole-gen… TRUE        "ACYC…      0 2022-10-2…             25 TRUE           acyc        
#>  7 acyc_mda_2015  Aden… "WGS of 21… TRUE        "ACYC…      0 2022-10-2…            102 TRUE           acyc        
#>  8 acyc_sanger_2… Aden… "Whole exo… TRUE        "ACYC…      0 2022-10-2…             24 TRUE           acyc        
#>  9 all_stjude_20… Acut… "Whole-gen… TRUE        "PUBL…      0 2022-10-2…             73 TRUE           bll         
#> 10 all_phase2_ta… Pedi… "Whole gen… TRUE        "NCI-…      0 2022-10-2…           1978 TRUE           bll         
#> # ℹ 365 more rows
...
#>   studyId         name  description publicStudy groups status importDate allSampleCount readPermission cancerTypeId
#>   <chr>           <chr> <chr>       <lgl>       <chr>   <int> <chr>               <int> <lgl>          <chr>       
#> 1 blca_nmibc_2017 Nonm… IMPACT seq… TRUE        PUBLIC      0 2022-10-2…            105 TRUE           blca        
#> 2 prad_msk_2019   Pros… MSK-IMPACT… TRUE        PUBLIC      0 2022-10-2…             18 TRUE           prostate    
#> # ℹ 3 more variables: referenceGenome <chr>, pmid <chr>, citation <chr>
```
...
#> 1 COPY_NUMBER_ALTERATION  DISCRETE Puta… Copy Numbe… TRUE                   FALSE        blca_nmibc_2017_c… blca_n…
#> 2 MUTATION_EXTENDED       MAF      Muta… Mutation d… TRUE                   FALSE        blca_nmibc_2017_m… blca_n…
#> 3 STRUCTURAL_VARIANT      SV       Stru… Structural… TRUE                   FALSE        blca_nmibc_2017_s… blca_n…
...
#>   molecularAlterationType datatype name  description showProfileInAnalysi…¹ patientLevel molecularProfileId studyId
#>   <chr>                   <chr>    <chr> <chr>       <lgl>                  <lgl>        <chr>              <chr>  
#> 1 COPY_NUMBER_ALTERATION  DISCRETE Puta… Putative c… TRUE                   FALSE        prad_msk_2019_cna  prad_m…
#> 2 MUTATION_EXTENDED       MAF      Muta… IMPACT468 … TRUE                   FALSE        prad_msk_2019_mut… prad_m…
#> 3 STRUCTURAL_VARIANT      SV       Stru… Structural… TRUE                   FALSE        prad_msk_2019_str… prad_m…
#> # ℹ abbreviated name: ¹​showProfileInAnalysisTab
```
...
#> 1 TERT                   7015 UC0wMDAxNDUzLV… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> 2 SMAD4                  4089 UC0wMDAxNDUzLV… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> 3 ERBB4                  2066 UC0wMDAxNDUzLV… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> 4 CUL3                   8452 UC0wMDAxNDUzLV… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> 5 PBRM1                 55193 UC0wMDAxNDUzLV… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
#> 6 APC                     324 UC0wMDAxNDUzLV… UC0wMDAxNDUzOmJ… blca_nmibc_2017_m… P-00014… P-0001453 blca_n… MSKCC 
...
#>  2 Cancer Type Detailed          Cancer Type Detail… STRING   FALSE            1        CANCER_TYPE_DETAIL… prad_m…
#>  3 Fraction Genome Altered       Fraction Genome Al… NUMBER   FALSE            20       FRACTION_GENOME_AL… prad_m…
...
#>  7 Sample Class                  The sample classif… STRING   FALSE            1        SAMPLE_CLASS        prad_m…
#>  8 Number of Samples Per Patient Number of Samples … STRING   TRUE             1        SAMPLE_COUNT        prad_m…
#>  9 Sample Type                   The type of sample… STRING   FALSE            1        SAMPLE_TYPE         prad_m…
#> 10 Sex                           Sex                 STRING   TRUE             1        SEX                 prad_m…
#> 11 Somatic Status                Somatic Status      STRING   FALSE            1        SOMATIC_STATUS      prad_m…
#> 12 Specimen Preservation Type    The method used fo… STRING   FALSE            1        SPECIMEN_PRESERVAT… prad_m…
