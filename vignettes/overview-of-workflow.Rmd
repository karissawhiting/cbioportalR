...
all_studies
#> # A tibble: 351 × 13
#>    studyId       name  descr…¹ publi…² groups status impor…³ allSa…⁴ readP…⁵
#>    <chr>         <chr> <chr>   <lgl>   <chr>   <int> <chr>     <int> <lgl>  
#>  1 acc_tcga      Adre… "TCGA … TRUE    "PUBL…      0 2022-0…      92 TRUE   
#>  2 bcc_unige_20… Basa… "Whole… TRUE    "PUBL…      0 2022-0…     293 TRUE   
#>  3 ampca_bcm_20… Ampu… "Exome… TRUE    "PUBL…      0 2022-0…     160 TRUE   
#>  4 blca_dfarber… Blad… "Whole… TRUE    "PUBL…      0 2022-0…      50 TRUE   
#>  5 blca_mskcc_s… Blad… "Compr… TRUE    "PUBL…      0 2022-0…      97 TRUE   
#>  6 blca_bgi      Blad… "Whole… TRUE    "PUBL…      0 2022-0…      99 TRUE   
#>  7 blca_mskcc_s… Blad… "Genom… TRUE    "PUBL…      0 2022-0…     109 TRUE   
#>  8 all_stjude_2… Hypo… "Whole… TRUE    ""          0 2022-0…      44 TRUE   
#>  9 acyc_fmi_2014 Aden… "Targe… TRUE    "ACYC…      0 2022-0…      28 TRUE   
#> 10 acyc_sanger_… Aden… "Whole… TRUE    "ACYC…      0 2022-0…      24 TRUE   
#> # … with 341 more rows, 4 more variables: cancerTypeId <chr>,
#> #   referenceGenome <chr>, pmid <chr>, citation <chr>, and abbreviated
#> #   variable names ¹​description, ²​publicStudy, ³​importDate,
...
#>   studyId        name  descr…¹ publi…² groups status impor…³ allSa…⁴ readP…⁵
#>   <chr>          <chr> <chr>   <lgl>   <chr>   <int> <chr>     <int> <lgl>  
#> 1 blca_nmibc_20… Nonm… IMPACT… TRUE    PUBLIC      0 2022-0…     105 TRUE   
#> 2 prad_msk_2019  Pros… MSK-IM… TRUE    PUBLIC      0 2022-0…      18 TRUE   
#> # … with 4 more variables: cancerTypeId <chr>, referenceGenome <chr>,
#> #   pmid <chr>, citation <chr>, and abbreviated variable names
#> #   ¹​description, ²​publicStudy, ³​importDate, ⁴​allSampleCount,
#> #   ⁵​readPermission
```
...
#> # A tibble: 3 × 8
#>   molecularAlteratio…¹ datat…² name  descr…³ showP…⁴ patie…⁵ molec…⁶ studyId
#>   <chr>                <chr>   <chr> <chr>   <lgl>   <lgl>   <chr>   <chr>  
#> 1 COPY_NUMBER_ALTERAT… DISCRE… Puta… Copy N… TRUE    FALSE   blca_n… blca_n…
#> 2 MUTATION_EXTENDED    MAF     Muta… Mutati… TRUE    FALSE   blca_n… blca_n…
#> 3 STRUCTURAL_VARIANT   SV      Stru… Struct… TRUE    FALSE   blca_n… blca_n…
#> # … with abbreviated variable names ¹​molecularAlterationType, ²​datatype,
#> #   ³​description, ⁴​showProfileInAnalysisTab, ⁵​patientLevel,
#> #   ⁶​molecularProfileId
```
...
#>   molecularAlteratio…¹ datat…² name  descr…³ showP…⁴ patie…⁵ molec…⁶ studyId
#>   <chr>                <chr>   <chr> <chr>   <lgl>   <lgl>   <chr>   <chr>  
#> 1 COPY_NUMBER_ALTERAT… DISCRE… Puta… Putati… TRUE    FALSE   prad_m… prad_m…
#> 2 MUTATION_EXTENDED    MAF     Muta… IMPACT… TRUE    FALSE   prad_m… prad_m…
#> 3 STRUCTURAL_VARIANT   SV      Stru… Struct… TRUE    FALSE   prad_m… prad_m…
#> # … with abbreviated variable names ¹​molecularAlterationType, ²​datatype,
#> #   ³​description, ⁴​showProfileInAnalysisTab, ⁵​patientLevel,
#> #   ⁶​molecularProfileId
```
...
#> [1] "blca_nmibc_2017_cna"                
#> [2] "blca_nmibc_2017_mutations"          
...
#> Genes: "IMPACT468"
#> # A tibble: 6 × 33
#>   hugoGeneS…¹ entre…² uniqu…³ uniqu…⁴ molec…⁵ sampl…⁶ patie…⁷ studyId center
#>   <chr>         <int> <chr>   <chr>   <chr>   <chr>   <chr>   <chr>   <chr> 
#> 1 TERT           7015 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC 
#> 2 SMAD4          4089 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC 
#> 3 ERBB4          2066 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC 
#> 4 CUL3           8452 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC 
#> 5 PBRM1         55193 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC 
#> 6 APC             324 UC0wMD… UC0wMD… blca_n… P-0001… P-0001… blca_n… MSKCC 
#> # … with 24 more variables: mutationStatus <chr>, validationStatus <chr>,
...
#> #   functionalImpactScore <chr>, fisValue <dbl>, linkXvar <chr>,
#> #   linkPdb <chr>, linkMsa <chr>, ncbiBuild <chr>, variantType <chr>,
...
#>  1 Cancer Type               Cancer… STRING  FALSE   1       CANCER… prad_m…
#>  2 Cancer Type Detailed      Cancer… STRING  FALSE   1       CANCER… prad_m…
#>  3 Fraction Genome Altered   Fracti… NUMBER  FALSE   20      FRACTI… prad_m…
#>  4 Gene Panel                Gene P… STRING  FALSE   1       GENE_P… prad_m…
#>  5 Mutation Count            Mutati… NUMBER  FALSE   30      MUTATI… prad_m…
#>  6 Oncotree Code             Oncotr… STRING  FALSE   1       ONCOTR… prad_m…
#>  7 Sample Class              The sa… STRING  FALSE   1       SAMPLE… prad_m…
#>  8 Number of Samples Per Pa… Number… STRING  TRUE    1       SAMPLE… prad_m…
#>  9 Sample Type               The ty… STRING  FALSE   1       SAMPLE… prad_m…
#> 10 Sex                       Sex     STRING  TRUE    1       SEX     prad_m…
#> 11 Somatic Status            Somati… STRING  FALSE   1       SOMATI… prad_m…
#> 12 Specimen Preservation Ty… The me… STRING  FALSE   1       SPECIM… prad_m…
#> 13 TMB (nonsynonymous)       TMB (n… NUMBER  FALSE   1       TMB_NO… prad_m…
#> # … with abbreviated variable names ¹​description, ²​datatype,
#> #   ³​patientAttribute, ⁴​priority, ⁵​clinicalAttributeId
```
...
#>   <chr>             <chr>     <chr>           <chr>                   <chr> 
#> 1 P-0001453-T01-IM3 P-0001453 blca_nmibc_2017 CANCER_TYPE             Bladd…
#> 2 P-0001453-T01-IM3 P-0001453 blca_nmibc_2017 CANCER_TYPE_DETAILED    Bladd…
...
#> 6 P-0001453-T01-IM3 P-0001453 blca_nmibc_2017 SOMATIC_STATUS          Match…
```
