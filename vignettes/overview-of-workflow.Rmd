...
all_studies
#> # A tibble: 353 × 13
#>    studyId        name  descr…¹ publi…² groups status impor…³ allSa…⁴ readP…⁵ cance…⁶ refer…⁷ pmid 
#>    <chr>          <chr> <chr>   <lgl>   <chr>   <int> <chr>     <int> <lgl>   <chr>   <chr>   <chr>
#>  1 acc_tcga       Adre… "TCGA … TRUE    "PUBL…      0 2022-0…      92 TRUE    acc     hg19    <NA> 
#>  2 bcc_unige_2016 Basa… "Whole… TRUE    "PUBL…      0 2022-0…     293 TRUE    bcc     hg19    2695…
#>  3 ampca_bcm_2016 Ampu… "Exome… TRUE    "PUBL…      0 2022-0…     160 TRUE    ampca   hg19    2680…
#>  4 blca_dfarber_… Blad… "Whole… TRUE    "PUBL…      0 2022-0…      50 TRUE    blca    hg19    2509…
#>  5 blca_mskcc_so… Blad… "Compr… TRUE    "PUBL…      0 2022-0…      97 TRUE    blca    hg19    2389…
#>  6 blca_bgi       Blad… "Whole… TRUE    "PUBL…      0 2022-0…      99 TRUE    blca    hg19    2412…
#>  7 blca_mskcc_so… Blad… "Genom… TRUE    "PUBL…      0 2022-0…     109 TRUE    blca    hg19    2509…
#>  8 all_stjude_20… Hypo… "Whole… TRUE    ""          0 2022-0…      44 TRUE    myeloid hg19    2333…
#>  9 acyc_fmi_2014  Aden… "Targe… TRUE    "ACYC…      0 2022-0…      28 TRUE    acyc    hg19    2441…
#> 10 acyc_sanger_2… Aden… "Whole… TRUE    "ACYC…      0 2022-0…      24 TRUE    acyc    hg19    2377…
#> # … with 343 more rows, 1 more variable: citation <chr>, and abbreviated variable names
#> #   ¹​description, ²​publicStudy, ³​importDate, ⁴​allSampleCount, ⁵​readPermission, ⁶​cancerTypeId,
#> #   ⁷​referenceGenome
```
...
#> 1 blca_n… Nonm… IMPACT… TRUE    PUBLIC      0 2022-0…     105 TRUE    blca    hg19    2858… Pietza…
#> 2 prad_m… Pros… MSK-IM… TRUE    PUBLIC      0 2022-0…      18 TRUE    prosta… hg19    3156… Granlu…
#> # … with abbreviated variable names ¹​description, ²​publicStudy, ³​importDate, ⁴​allSampleCount,
...
#> 1 COPY_NUMBER_ALTERATION  DISCRETE Putative copy-number al… Copy N… TRUE    FALSE   blca_n… blca_n…
#> 2 MUTATION_EXTENDED       MAF      Mutations                Mutati… TRUE    FALSE   blca_n… blca_n…
#> 3 STRUCTURAL_VARIANT      SV       Structural variants      Struct… TRUE    FALSE   blca_n… blca_n…
#> # … with abbreviated variable names ¹​description, ²​showProfileInAnalysisTab, ³​patientLevel,
#> #   ⁴​molecularProfileId
```
...
#>   molecularAlterationType datatype name                     descr…¹ showP…² patie…³ molec…⁴ studyId
#>   <chr>                   <chr>    <chr>                    <chr>   <lgl>   <lgl>   <chr>   <chr>  
#> 1 COPY_NUMBER_ALTERATION  DISCRETE Putative copy-number al… Putati… TRUE    FALSE   prad_m… prad_m…
#> 2 MUTATION_EXTENDED       MAF      Mutations                IMPACT… TRUE    FALSE   prad_m… prad_m…
#> 3 STRUCTURAL_VARIANT      SV       Structural variants      Struct… TRUE    FALSE   prad_m… prad_m…
#> # … with abbreviated variable names ¹​description, ²​showProfileInAnalysisTab, ³​patientLevel,
#> #   ⁴​molecularProfileId
```
...
#> Genes: "IMPACT468"
#> # A tibble: 6 × 33
#>   hugoGe…¹ entre…² uniqu…³ uniqu…⁴ molec…⁵ sampl…⁶ patie…⁷ studyId center mutat…⁸ valid…⁹ tumor…˟ tumor…˟
...
#>  9 Sample Type                   The type of sample (i.e., norma… STRING  FALSE   1       SAMPLE… prad_m…
#> 10 Sex                           Sex                              STRING  TRUE    1       SEX     prad_m…
#> 11 Somatic Status                Somatic Status                   STRING  FALSE   1       SOMATI… prad_m…
#> 12 Specimen Preservation Type    The method used for preparing t… STRING  FALSE   1       SPECIM… prad_m…
